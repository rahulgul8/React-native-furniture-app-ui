    ...
    render() {
        return (
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Detail')} style={styles.container}>
                <Image source={this.props.src} style={{ width: 170, height: 110, borderRadius: 10 }} />
                <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 10 }}>
                    <Text style={{ fontFamily: "Bold", color: "#4f4a4a", fontSize: 12 }}>
                        {this.props.name}
                    </Text>
                ...
                <Text style={{ fontSize: 9, color: "#4f4a4a", fontFamily: "Regular" }}>
                ...
                <View style={{ flexDirection: "row", marginTop: 5, alignItems: "center", width: "100%" }}>
                    <View style={{ width: "80%" }}>
                        <Text style={{ fontSize: 15, fontFamily: "Bold" }}>324.69 USD</Text>
                    </View>
                    <View style={{ width: "20%" }}>
